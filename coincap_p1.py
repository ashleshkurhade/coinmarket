...
url_end='?structure=array&converts='+convert

listing_url='https://api.coinmarketcap.com/v2/listings/?converts='+convert
...
print()
print('API results updated on'+last_updated_string)
print()
